...
{
	.fields={
		.pin_first = STM32F4_GPIO_PIN(5, 9),
	.pin_last = STM32F4_GPIO_PIN(5, 9),
...
#define LED_ON() stm32f4_gpio_set_output(STM32F4_GPIO_PIN(5,9), 1)
#define LED_OFF() stm32f4_gpio_set_output(STM32F4_GPIO_PIN(5,9), 0)
